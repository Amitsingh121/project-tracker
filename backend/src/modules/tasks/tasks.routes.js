 ...
 */
// Mounted at /api/projects/:projectId/tasks (mergeParams: true)
 ...
 *   patch:
 *     tags: [Tasks]
 *     summary: Update a task (permissions depend on role - ADMIN can edit all fields; MEMBER can edit their own or update status if assigned)
 *     parameters:
 *       - in: path
 *         name: taskId
 *         required: true
